...
const Customize500 = () => {
  ...
  return (
    <div className="bg-white min-h-screen">
        ...
        <main className="p-4 md:p-6">
          ...
          <div className="max-w-4xl mx-auto space-y-8 md:space-y-12">
            <div className="space-y-4">
              <img
                src="/lovable-uploads/500-front-template.png"
                alt="500 Currency Front Template"
            ...
            <div className="space-y-4">
              <img
                src="/lovable-uploads/500-back.jpg"
                alt="500 Currency Back"
                className="w-full rounded-lg shadow-md"
              />
              <div className="flex flex-wrap gap-4">
                <button className="px-4 md:px-6 py-3 border border-bluePrimary text-bluePrimary rounded-lg hover:bg-bluePrimary hover:text-white transition-colors">
      ...
      {showEditor && (
        <CurrencyEditor
          currencyImage="/lovable-uploads/500-front-template.png"
